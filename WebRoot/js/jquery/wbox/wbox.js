...
(function($){
    ...
    $.fn.wBox = function(options){
        ...
        var  wBoxHtml = '<div id="wBox"><div class="wBox_popup"><table><tbody><tr><td class="wBox_tl"/><td class="wBox_b"/><td class="wBox_tr"/></tr><tr><td class="wBox_b"><div>&nbsp;</div></td><td class="wBox_body">' + (_this.YQ.noTitle ? '' : '<div class="wBox_close"></div>') +
        ...
        function calPosition(w){
            l = ($win.width() - w) / 2;
            t = $win.scrollTop()+50 + $win.height() /6;
            return [l, t];
        }
        /*
         * 拖拽函数drag
