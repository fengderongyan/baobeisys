...
(function () {
     ...
     * window.UEDITOR_HOME_URL = "/xxxx/xxxx/"; UEDITOR_APP//把项目名称传到js中，到时候保存和展示图片路径用
     */
    var UEDITOR_APP = window.UEDITOR_APP;
    var FILE_DIR = window.FILE_DIR;// 图片或其他附件上传的文件路径
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"jsp/imageUp.jsp?file_dir="+FILE_DIR  //图片上传提交地址
        ,imagePath:URL + "jsp/"                     		//图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,modulePrefix:UEDITOR_APP                  			//把项目名称传到js中，到时候保存和展示图片路径用
        ...
        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp?file_dir="+FILE_DIR  //附件上传提交地址
        ...
        ,modulePrefix2:UEDITOR_APP 					//把项目名称传到js中，到时候保存和展示图片路径用
		...
		, toolbars: [["fullscreen","source","|","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","insertimage","snapscreen","fontfamily","fontsize","bold","italic","underline","strikethrough","forecolor","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","indent","rowspacingbottom","rowspacingtop","lineheight"],[]]
