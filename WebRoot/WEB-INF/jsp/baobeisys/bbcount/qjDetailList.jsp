...
<head>
	...
	<body>
		<sgy:csrfToken />
		<display:table name="list" requestURI="${app}/bbcount/qjDetailList.do"
			...
			<display:column title="请假类别" property="qj_type"/>
			<display:column title="天数" property="bb_day_cnt" style="width: 120px;"/>
			<display:column title="开始时间" property="begin_date" style="width: 140px;"/>
			<display:column title="结束时间" property="end_date"/>
		</display:table>
	</body>
