...
<head>
	...
	<body>
		<sgy:csrfToken />
		<display:table name="list" requestURI="${app}/bbcount/ycDetailList.do"
			...
			<display:column title="用车原因" property="yc_reason"/>
			<display:column title="所用车型" property="car_type" />
			<display:column title="开始时间" property="begin_date" />
		</display:table>
	</body>
