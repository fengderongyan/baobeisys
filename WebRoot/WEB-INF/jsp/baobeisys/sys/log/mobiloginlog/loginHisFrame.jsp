...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" action="${app}/sys/log/mobileLoginHisList.do" target="listQuery">
			<sgy:csrfToken />
			<div id="queryPanel" class="queryPanel">
				...
				<div id="queryPanel_content" class="queryPanel_content" style="position: relative;">
					...
					<div id="queryPanel_footer" class="queryPanel_footer"
						...
						<!--<sgy:button cssClass="ovalbutton" id="exptbtn" onclick="expt();return false;">导 出</sgy:button> -->
					</div>
				</div>
			</div>
